    ...
    <>
      ...
      >
        <div
          ...
          ${scrolled
              ? "bg-ink/85 border-white/15 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.4)]"
        ...
        >
          <Link
            href="/"
            className="px-3 md:px-4 py-2 font-display font-bold tracking-[0.12em] uppercase text-xs md:text-sm text-white"
          >
